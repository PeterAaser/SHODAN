* ThoughtPad
  I GA gikk vi vekk fra pipe for å få ting til å funke, men feilen var at pipe join var fucked.
  Kanskje bedre å gå tilbake til Pipe og bruke joinPipe
  
  Kanskje vi ikke skal ha en Input filter i experiment?
  
* Neste gang
  Sjekke hvordan blanking tar seg ut i MeaUSB

* Doing
  Hvorfor funker både Effect og Concurrent i fileIO??
  

* Now 
** TODO Separate out Experiment, use XOR as trial
** TODO Create XOR challenge
** TODO Make resettable pipe with join for flushing residual averages
  
** TODO Gather up agent stuff in Maze
*** TODO Decouple agentPipe.evaluatorPipe into evaluator and taskRunner
...
** TODO Refactor into API packages kinda
*** DONE DSP
*** DONE Files
*** DONE TCP
*** TODO Http
