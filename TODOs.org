* Neste gang
  Did I forget to put data to the topics??
  Turns out I printed the stream rather than mapping it with print...
  
  Why does nothing happen??

* Doing
** Implement stim sites
...
* TODO Add tests
* TODO Implement stim sites on MEAME
