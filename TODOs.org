...
* Doing
** TODO Refactor the DSP config and stim pipeline
*** TODO RPC still has DspCalls._
*** TODO Stim request pipe
*** TODO DSP comms rewrite
  
* Now 
** TODO Refactor into API packages kinda
*** DONE DSP
*** TODO Resten...
** TODO Revisit the setup flow now that the DSP actually works
