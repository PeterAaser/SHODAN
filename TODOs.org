* Neste gang
** Se på visualisering
   Legge til bedre filtere? Altså voltage etc?
   Sette det til 2 sek vindu
** Mer om stimuli
   Få det til å funke på fler kanaler.
   Fikse notater med MCS folka
** Snakke med Neshat om å hente data?
*** Vurdere en egen modul for å snakke med roboter?
...
* TODO Chunk all data from TCP for easier restarts etc
...
** DONE MEAME
** TODO SHODAN
   see: [[*Chunk all data from TCP for easier restarts etc][Chunk Incoming]] 
   also: UI
