* Neste gang
  Noe veldig rart som skjer med downsampling og masse topics. Tom for minne?
  For mye jobb å lage simple case, la det være inntil videre.
  
  Holder på med DSP confing fra SHODAN.
  
**  Se på db stuff
   Lag en recording der hver kanal har kun en verdi, sjekk om det stemmer med visualizer
