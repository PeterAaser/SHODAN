...
* `cyborg.frontend.routing` - all the code related to the frontend application routing.
* `cyborg.frontend.services` - the business logic of the client application.
* `cyborg.frontend.views` - the code describing views and their behaviour.

The root package (`cyborg.frontend`) also contains `JSLauncher` and `ApplicationContext`. The former 
